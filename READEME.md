ChildEval/
├── prompts/        # the prompts for  generate data
├── data/       # the full clean data and some original generation examples
├── evaluationScripts/      # the evaluation scripts and their corresponding prompts
└── Readme.md   # the explaination
